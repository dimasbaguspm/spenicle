...
interface FormProps {
  defaultValues?: Partial<CategoryUpdateFormSchema>;
  handleOnValidSubmit: (data: CategoryUpdateFormSchema) => Promise<void>;
}

export const Form = ({ defaultValues, handleOnValidSubmit }: FormProps) => {
  const { handleSubmit, control } = useForm<CategoryUpdateFormSchema>({
    defaultValues,
  });
