...
interface FormProps {
  defaultValues?: Partial<AccountCreateFormSchema>;
  handleOnValidSubmit: (data: AccountCreateFormSchema) => Promise<void>;
}

export const Form = ({ defaultValues, handleOnValidSubmit }: FormProps) => {
  const { handleSubmit, control } = useForm<AccountCreateFormSchema>({
    defaultValues,
  });
