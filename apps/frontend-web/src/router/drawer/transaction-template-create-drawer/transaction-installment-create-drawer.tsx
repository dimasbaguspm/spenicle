...
interface TransactionInstallmentCreateDrawerProps {
  payload?: Record<string, string>;
}

export const TransactionInstallmentCreateDrawer: FC<
  TransactionInstallmentCreateDrawerProps
> = ({ payload }) => {
  ...
  const handleOnValidSubmit = async (
    ...
    await createTemplate({
      ...
      endDate: formatDate(data.endDate!, DateFormat.ISO_DATETIME),
      type: data.type,
    ...
    showSnack("success", "Installment transaction created successfully");
    closeDrawer();
  };
  ...
  return (
    <>
      <Drawer.Header>
        <Drawer.Title>Create Installment Transaction</Drawer.Title>
        <Drawer.CloseButton />
      </Drawer.Header>
