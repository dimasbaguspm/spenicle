...
export const formId = "new-transaction-template-form";

interface FormProps {
  defaultValues?: Partial<TransactionTemplateCreateFormSchema>;
  handleOnValidSubmit: (
...
export const Form = ({
  ...
  const { handleSubmit, control } =
    useForm<TransactionTemplateCreateFormSchema>({
      defaultValues,
    });
        ...
        },
        {
          ...
          state: {
            ...
            returnToDrawer: isInstallment
              ? DRAWER_ROUTES.TRANSACTION_INSTALLMENT_CREATE
              : DRAWER_ROUTES.TRANSACTION_RECURRING_CREATE,
          },
        },
      );
    };
