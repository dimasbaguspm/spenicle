...
type SummaryParamModel struct {
	StartDate time.Time `query:"startDate" doc:"Start date for filtering (ISO 8601 format)" example:"2024-01-01T00:00:00Z"`
	EndDate   time.Time `query:"endDate" doc:"End date for filtering (ISO 8601 format)" example:"2024-12-31T23:59:59Z"`
}
