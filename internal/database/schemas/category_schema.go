...
type CategorySchema struct {
	...
	Icon         *string    `json:"icon,omitempty" doc:"Icon identifier set by frontend" example:"food-icon"`
	IconColor    *string    `json:"iconColor,omitempty" doc:"Icon color in hex format" example:"#FF5733"`
