...
type CreateTransactionSchema struct {
	...
	AccountID  int        `json:"account_id" doc:"Foreign key to accounts table" example:"1" minimum:"1"`
	CategoryID int        `json:"category_id" doc:"Foreign key to categories table" example:"1" minimum:"1"`
