...
import { CATEGORY_ICONS } from '../category-icon/constants';
        ...
        {CATEGORY_ICONS.map((iconOption) => {
          ...
          return (
            <button
              ...
              type="button"
              className={`h-10 w-10 rounded-full border-2 transition-all duration-200 flex items-center justify-center ${
                isSelected
