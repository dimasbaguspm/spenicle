...
export interface CategorySelectorProps extends VariantProps<typeof categorySelectorVariants> {
  value?: Category | null;
  ...
  return (
    <div className={cn('w-full', wrapperClassName)}>
      ...
      <button
        ...
        aria-controls={id ? `${id}-category-modal` : undefined}
      >
        ...
        <span className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
          <Tag className={cn('h-4 w-4 text-slate-400', disabled && 'text-slate-300')} />
        </span>
      </button>
