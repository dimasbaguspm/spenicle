...
interface MobileCategoriesLoaderProps {
  count?: number;
}

/**
 * Loading state component for mobile categories
 * Follows the same pattern as mobile period breakdown loader
 */
export const MobileCategoriesLoader: React.FC<MobileCategoriesLoaderProps> = ({ count = 5 }) => (
